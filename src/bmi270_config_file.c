/**
 * @file bmi270_config_file.c
 * @brief BMI270 Configuration File Data
 *
 * Official Bosch Sensortec BMI270 configuration file (8192 bytes).
 * This data enables advanced BMI270 features and must be uploaded
